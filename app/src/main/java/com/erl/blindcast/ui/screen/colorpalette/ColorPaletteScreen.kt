package com.erl.blindcast.ui.screen.colorpalette
...
import com.erl.blindcast.BlindCastApplication
...
fun ColorPaletteScreen() {
    ...
    val actions = ColorPaletteScreenActions(
        ...
        onSetEnablePredictiveBack = {
            ...
            BlindCastApplication.setEnableOnBackInvokedCallback(context.applicationInfo, it)
            activity?.recreate()
        },
