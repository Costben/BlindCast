...
// 上游原文：app/src/main/java/com/aliothmoon/maameow/third/wrappers/WindowManager.java
...
public final class WindowManager {
    ...
    public boolean registerTaskFpsCallback(int taskId, Object callback) {
        try {
            ...
            Log.e(TAG, "[MeowWindowManager] Could not invoke method", e);
            return false;
        }
    }
...
//        } catch (Exception e) {
//            Log.e(TAG, "[MeowWindowManager] Could not register display window listener", e);
//        }
//        return null;
//    }
//
...
//        } catch (Exception e) {
//            Log.e(TAG, "[MeowWindowManager] Could not unregister display window listener", e);
//        }
//    }
    ...
    public void freezeRotation(int displayId, int rotation) {
        try {
            ...
            switch (freezeDisplayRotationMethodVersion) {
                ...
                default:
                    if (displayId != 0) {
                        Log.e(TAG, "[MeowWindowManager] Secondary display rotation not supported on this device");
                        return;
                    }
    ...
    public void setDisplayImePolicy(int displayId, int displayImePolicy) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= AndroidVersions.API_31_ANDROID_12) {
                ...
                Log.w(TAG, "[MeowWindowManager] DISPLAY_IME_POLICY_HIDE is not supported before Android 12");
            }
        } catch (ReflectiveOperationException e) {
            Log.e(TAG, "[MeowWindowManager] Could not invoke method", e);
        }
    ...
    public void captureDisplay(int displayId, Object captureArgs, Object listener) {
        try {
            ...
            Log.e(TAG, "[MeowWindowManager] Could not invoke captureDisplay", e);
    ...
    public Boolean isKeyguardLocked() {
        try {
            ...
            Log.e(TAG, "[MeowWindowManager] Could not invoke isKeyguardLocked", e);
            return null;
        }
    }
    ...
    public Boolean isKeyguardSecure(int userId) {
        try {
            ...
            Log.e(TAG, "[MeowWindowManager] Could not invoke isKeyguardSecure", e);
            return null;
        }
    }
    ...
    public boolean dismissKeyguard() {
        try {
            ...
            Log.e(TAG, "[MeowWindowManager] Could not invoke dismissKeyguard", e);
            return false;
        }
    }
    ...
    public boolean lockNow() {
        try {
            ...
            Log.e(TAG, "[MeowWindowManager] Could not invoke lockNow", e);
            return false;
        }
    }
}
